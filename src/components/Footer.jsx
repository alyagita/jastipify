...
const Footer = () => {
  return (
      <footer className="bg-[#f0f0f0] mt-16 py-12">
    <div className="container mx-auto px-4">
      {/* Footer Content */}
      <div className="grid grid-cols-4 gap-8">
        {/* Company Info */}
        <div>
          <h2 className="text-2xl font-bold mb-4">Jastipify</h2>
          <p className="text-gray-600 mb-6">
            A trusted and integrated platform that streamlines the process of purchasing international products with transparency and convenience.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="text-gray-600 hover:text-[#fb8500]">About</a></li>
            <li><a href="#" className="text-gray-600 hover:text-[#fb8500]">Features</a></li>
            <li><a href="#" className="text-gray-600 hover:text-[#fb8500]">Works</a></li>
            <li><a href="#" className="text-gray-600 hover:text-[#fb8500]">Career</a></li>
          </ul>
        </div>
